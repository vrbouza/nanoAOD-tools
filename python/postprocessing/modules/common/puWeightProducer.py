...
pufile_data5TeV="%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/pileup_5TeV.root" % os.environ['CMSSW_BASE']
pufile_mc5TeV="%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/PileupMC_5TeV.root" % os.environ['CMSSW_BASE']
puWeight_5TeV = lambda : puWeightProducer(pufile_mc5TeV,pufile_data5TeV,"pu_mc","pileup",verbose=False, doSysVar=True, nvtx_var='Pileup_nPU')
puAutoWeight_5TeV = lambda : puWeightProducer("auto",pufile_data5TeV,"pu_mc","pileup",verbose=False, nvtx_var='Pileup_nPU')
